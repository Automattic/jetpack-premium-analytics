 ...
 *                                    Default 'false'.
 */
function jpa_override_script( $scripts, $handle, $src, $deps = array(), $ver = false, $in_footer = false ) {
 ...
 */
function jpa_register_package_scripts( $scripts ) {
...
add_action( 'wp_default_scripts', 'jpa_register_package_scripts' );
