 ...
 *
 * Note: These styles can be overridden by calling jpa_override_style()
 ...
 */
function jpa_override_style( $styles, $handle, $src, $deps = array(), $ver = false, $media = 'all' ) {
 ...
 * @param WP_Styles $styles WP_Styles instance.
 */
function jpa_register_package_styles( $styles ) {
...
add_action( 'wp_default_styles', 'jpa_register_package_styles' );
