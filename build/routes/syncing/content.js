...
// routes/syncing/components/syncing/syncing.tsx
...
// routes/syncing/components/syncing/style.scss
if (typeof document !== "undefined" && true && !document.head.querySelector("style[data-wp-hash='8c9663dbe4']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "8c9663dbe4");
  style.appendChild(document.createTextNode(".jetpack-premium-analytics-syncing{max-width:450px;text-align:center}.jetpack-premium-analytics-syncing__title{font-size:var(--wpds-typography-font-size-xl,20px);font-weight:var(--wpds-typography-font-weight-medium,499);line-height:var(--wpds-typography-line-height-lg,28px)}.jetpack-premium-analytics-syncing__description{color:var(--wpds-color-fg-content-neutral-weak,#707070);font-size:var(--wpds-typography-font-size-md,13px);line-height:var(--wpds-typography-line-height-sm,20px)}.jetpack-premium-analytics-syncing__progress{text-align:left;width:100%}.jetpack-premium-analytics-syncing__percentage{color:var(--wpds-color-fg-content-neutral-weak,#707070);font-size:var(--wpds-typography-font-size-sm,12px);line-height:var(--wpds-typography-line-height-xs,16px)}"));
  document.head.appendChild(style);
}
...
function Syncing() {
  const { data, error: error2, isLoading, isComplete, isStalled, triggerSync } = useSyncStatus();
  const [isTriggering, setIsTriggering] = (0, import_react3.useState)(false);
  const didAutoTrigger = (0, import_react3.useRef)(false);
  ...
  const handleTriggerSync = (0, import_react3.useCallback)(async () => {
  ...
  const title = error2 ? (0, import_i18n2.__)("Sync interrupted", "jetpack-premium-analytics") : (0, import_i18n2.__)("We're preparing your data", "jetpack-premium-analytics");
  const description = error2 ? (0, import_i18n2.__)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Stack, { direction: "column", gap: "xl", align: "center", className: "jetpack-premium-analytics-syncing", children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Connection, {}),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Stack, { direction: "column", gap: "sm", align: "center", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "jetpack-premium-analytics-syncing__title", children: title }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "jetpack-premium-analytics-syncing__description", children: description })
    ] }),
    !error2 && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      Stack,
      {
        direction: "column",
        gap: "sm",
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_components.ProgressBar, { value: percentage }),
          !isLoading && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { className: "jetpack-premium-analytics-syncing__percentage", children: [
            percentage,
            "%"
          ] })
        ]
    ...
    (error2 || isStalled) && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      Button4,
      {
        variant: "solid",
        ...
        children: (0, import_i18n2.__)("Try again", "jetpack-premium-analytics")
      }
    )
  ] });
}

// routes/syncing/style.scss
if (typeof document !== "undefined" && true && !document.head.querySelector("style[data-wp-hash='008802483d']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "008802483d");
  style.appendChild(document.createTextNode(".jetpack-premium-analytics-syncing-stage{height:100%}"));
  document.head.appendChild(style);
}

// routes/syncing/stage.tsx
var import_jsx_runtime6 = __toESM(require_jsx_runtime());
var stage = () => {
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Stack, { align: "center", justify: "center", className: "jetpack-premium-analytics-syncing-stage", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Syncing, {}) });
};
export {
  stage
};
