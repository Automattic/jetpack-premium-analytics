...
function createEffect(fn, value, options) {
  ...
  const c2 = createComputation(fn, value, false, STALE), s2 = SuspenseContext && useContext2(SuspenseContext);
...
function createResource(pSource, pFetcher, pOptions) {
  ...
  function read() {
    const c2 = SuspenseContext && useContext2(SuspenseContext), v = value(), err = error();
...
var init_ZDWCUMSJ = __esm({
  "../../../node_modules/.pnpm/@tanstack+query-devtools@5.90.1/node_modules/@tanstack/query-devtools/build/chunk/ZDWCUMSJ.js"() {
    ...
    PiPContext = createContext2(void 0);
    PiPProvider = (props) => {
...
// widgets/react-query-dev-tool/render.tsx
  ...
  mount(el) {
    ...
    const dispose3 = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => Promise.resolve().then(() => (init_AITGKQY(), AITGKQY_exports)));
...
// widgets/react-query-dev-tool/style.module.css
if (typeof process === "undefined" || true) {
  registerStyle("10e4f4bcee", "._1b0b7870465d49cf__root{height:100%;min-height:480px;overflow:auto}");
}
var style_default2 = { "root": "_1b0b7870465d49cf__root" };

// widgets/react-query-dev-tool/render.tsx
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
function ReactQueryDevTool() {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: style_default2.root, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ReactQueryDevtoolsPanel2, { client: queryClient, style: { height: "100%" } }) });
}
export {
  ReactQueryDevTool as default
};
